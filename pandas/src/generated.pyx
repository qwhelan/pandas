...
def group_ohlc_float64(ndarray[float64_t, ndim=2] out,
    ...
    cdef:
        Py_ssize_t i, j, N, K, ngroups, b
        float64_t val, count
        float64_t vopen = np.nan
        float64_t vhigh = np.nan
        float64_t vlow = np.nan
        float64_t vclose = np.nan
        float64_t NA = np.nan
        bint got_first = 0
...
def group_ohlc_float32(ndarray[float32_t, ndim=2] out,
    ...
    cdef:
        Py_ssize_t i, j, N, K, ngroups, b
        float32_t val, count
        float32_t vopen = np.nan
        float32_t vhigh = np.nan
        float32_t vlow = np.nan
        float32_t vclose = np.nan
        float32_t NA = np.nan
        bint got_first = 0
